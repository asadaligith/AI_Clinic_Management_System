      ...
      <div className="table-container">
        <table className="data-table">
          ...
          <tbody>
            {loading ? (
              <tr>
                <td colSpan="5" className="table-empty">Loading receptionists...</td>
              </tr>
            ) : receptionists.length === 0 ? (
              <tr>
                <td colSpan="5" className="table-empty">No receptionists found.</td>
              </tr>
            ) : (
              receptionists.map((r) => (
                <tr key={r._id}>
                  ...
                  <td>
                    <span
                      ...
                      style={{ background: r.isActive ? "#2ecc71" : "#e74c3c" }}
                    >
      ...
      {pagination.pages > 1 && (
        <div className="table-pagination">
          <button
            ...
            onClick={() => fetchReceptionists(pagination.page - 1)}
          >
            Previous
          </button>
